...
const sum = (...n) => n.reduce(((acumulador, proximo = 0) => acumulador + proximo), 0);
...
const filterPeople = (arr) =>
   arr.filter(({bornIn, nationality}) => bornIn > 1900 && bornIn <= 2000 && nationality === 'Australian');
...
const swap = ([a, b, c]) => {let = newList = [c, b, a]; return newList;}
...
const toObject = ([nome, marca, ano]) => { return { name: nome, brand: marca, year: ano }; } 
